...
import { styles } from "./ataquedirecionado.style.js"; // Importando estilos

function abrirLink(url) {
  Linking.openURL(url); // Função para abrir links externos
}

function AtaqueDirecionado() {
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.header}>Ataque Direcionado</Text>
...
export default AtaqueDirecionado;
