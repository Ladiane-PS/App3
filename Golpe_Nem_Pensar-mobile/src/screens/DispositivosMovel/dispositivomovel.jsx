...
import { styles } from "./dispositivomovel.style.js"; // Importando estilos

function abrirLink(url) {
  Linking.openURL(url); // Função para abrir links externos
}

function DispositivosMovel() {
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.header}>Dispositivos Móveis Seguros</Text>
...
export default DispositivosMovel;
