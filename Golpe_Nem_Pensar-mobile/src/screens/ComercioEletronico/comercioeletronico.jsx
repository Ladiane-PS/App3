...
import { styles } from "./comercioeletronico.style.js"; // Importando estilos

function abrirLink(url) {
  Linking.openURL(url); // Função para abrir links externos
}

function ComercioEletronico() {
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.header}>Comércio Eletrônico Seguro</Text>
...
export default ComercioEletronico;
